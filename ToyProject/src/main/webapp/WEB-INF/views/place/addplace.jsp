...
<body>
	...
	<main id="main">
		...
		<table>
			...
			<tr>
				<th>해시태그</th>
				<td><input type="text" name="hashtag"  required class="full"></td>
				
			</tr>
			
		</table>
		<div>
			<button type="submit" class="back" onclick="location.href='/toy/place/place.do';">돌아가기</button>
...
<script>
	...
	let $input = $('input[name=hashtag]').tagify();
